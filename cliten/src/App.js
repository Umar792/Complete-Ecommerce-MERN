...
function App() {
  ...
  const PrivateRoute = () => {
    return !isAuthanticated ? <Navigate to="/" replace />
      : <Outlet />
  }   
  const PrivateRouteadmin = () => {
    return isAuthanticated === false && user.role !== "admin" ? <Navigate to="/" replace />
      : <Outlet />
  }   
  ...
  return (
    ...
    <Routes>
      ...
      <Route path='/singleProduct/:id' exact element={<SingleProductDetals />} />
      {/* ========== user  */}
      ...
      <Route path='/password/reset/:token' exact element={<RessetPassword />} />
  
      {/* ================== card  */}
  
      <Route exact path='/card' element={<Card />} />
      <Route exact path='/login/shipping' element={<Shipping />} />
      <Route exact path='/login/shipping/conform/shipping' element={<ConfirmOrder />} />
      ...
      <Route path='/admin/product/create' exact element={<PrivateRouteadmin />}>
        <Route exact path='/admin/product/create' element={<CreateProduct />} />
      </Route>
      <Route path='/admin/product/adminUpdateProduct/:id' exact element={<PrivateRouteadmin />}>
        <Route exact path='/admin/product/adminUpdateProduct/:id' element={<AdminUpdateProduct />} />
      </Route>
      <Route path='/admin/orders' exact element={<PrivateRouteadmin />}>
        <Route exact path='/admin/orders' element={<Allorders />} />
      </Route>
      <Route path='/admin/order/update/:id' exact element={<PrivateRouteadmin />}>
      ...
      <Route path='/admin/user/updateuser/:id' exact element={<PrivateRouteadmin />}>
        <Route exact path='/admin/user/updateuser/:id' element={<UpdateUserRole />} />
      </Route>
