...
const OrderProvider = ({children})=>{
    ...
    const CreateOrder = async(order,navigate)=>{
       try {
        ...
        const res = await fetch("http://localhost:4000/order/new",{
            method:"post",
            headers:{
    ...
    const myOrderget = async()=>{
       try {
        ...
        const res = await fetch("http://localhost:4000/loginUserOrder",{
            method:"get",
            headers:{
                "Content-Type" : "application/json",
                token : localStorage.getItem("Token")
    ...
    const GetSingleOrder = async(id)=>{
       try {
        ...
        const res = await fetch(`http://localhost:4000/singleOrder/${id}`,{
            method:"get",
            headers:{
                "Content-Type" : "application/json",
                token : localStorage.getItem("Token")
    ...
    const DeleteOrder = async(id)=>{
        try {
         ...
         const res = await fetch(`http://localhost:4000/deleteOrder/${id}`,{
             method:"delete",
             headers:{
                 "Content-Type" : "application/json",
                 token : localStorage.getItem("Token")
    ...
    const UpdateSatus = async(id,status,navgate)=>{
        try {
         ...
         const res = await fetch(`http://localhost:4000/UpdateOrderStatus/${id}`,{
             method:"PUT",
             headers:{
                 "Content-Type" : "application/json",
                 token : localStorage.getItem("Token")
    ...
    return <OrderContext.Provider value={{...state,UpdateSatus,DeleteOrder,GetAllOrder,CreateOrder,myOrderget,GetSingleOrder}}>{children}</OrderContext.Provider>
}
