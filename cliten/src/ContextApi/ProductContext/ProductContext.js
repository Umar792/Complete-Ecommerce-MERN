...
const ProductProvider = ({ children }) => {
  ...
  const getAllproducts = async (price = [0, 25000]) => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/allproduct?price[gte]=${price[0]}&price[lte]=${price[1]}`,
        {
          method: "get",
          headers: {
            "Content-Type": "accplication/json",
  ...
  const getAllAdminProducts = async () => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/AdminallProducts`,
        {
          method: "get",
          headers: {
            "Content-Type": "accplication/json",
  ...
  const CreateProduct = async (productDatat) => {
    try {
      ...
      const res = await fetch(
        "https://ochre-dhole-wig.cyclic.app/product/new",
        {
          method: "post",
          headers: {
  ...
  const DeleteProduct = async (id, navigate) => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/productDelete/${id}`,
        {
          method: "delete",
          headers: {
            "Content-Type": "accplication/json",
  ...
  const UpdateProduct = async (id, productData, navigate) => {
    try {
      ...
      const { data } = await axios.put(
        `https://ochre-dhole-wig.cyclic.app/productUpadte/${id}`,
        productData,
        config
      );
  ...
  const getfilterproducts = async (keyword = "") => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/allproduct?keyword=${keyword}`,
        {
          method: "get",
          headers: {
            "Content-Type": "accplication/json",
  ...
  const SubmitReview = async (reviedata) => {
    try {
      ...
      const res = await fetch(`https://ochre-dhole-wig.cyclic.app/review`, {
        method: "put",
        headers: {
          "Content-Type": "accplication/json",
          token: localStorage.getItem("Token"),
