...
const UserProvider = ({ children }) => {
  ...
  const userRegistration = async (name, email, password, navigate, avatar) => {
    try {
      ...
      const res = await fetch(
        "https://ochre-dhole-wig.cyclic.app/registration",
        {
          method: "POST",
          headers: {
  ...
  const userLogin = async (email, password, navigate) => {
    try {
      ...
      const res = await fetch("https://ochre-dhole-wig.cyclic.app/login", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const getLoginUserData = async () => {
    try {
      ...
      const res = await fetch("https://ochre-dhole-wig.cyclic.app/me", {
        method: "get",
        headers: {
          "Content-type": "application/json",
  ...
  const updatePassword = async (oldpassword, newpassword, navigate) => {
    try {
      ...
      const res = await fetch(
        "https://ochre-dhole-wig.cyclic.app/updatePassword",
        {
          method: "put",
          headers: {
            "Content-type": "application/json",
  ...
  const fortogPassword = async (email) => {
    try {
      ...
      const res = await fetch(
        "https://ochre-dhole-wig.cyclic.app/fortogPassword",
        {
          method: "post",
          headers: {
            "Content-Type": "application/json",
  ...
  const RestPassword = async (password, navigate, token) => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/password/reset/${token}`,
        {
          method: "put",
          headers: {
            "Content-Type": "application/json",
  ...
  const getAllUser = async () => {
    try {
      ...
      const res = await fetch(`https://ochre-dhole-wig.cyclic.app/allusers`, {
        method: "get",
        headers: {
          "Content-Type": "application/json",
          token: localStorage.getItem("Token"),
  ...
  const DeleteSingleUser = async (id, navigate) => {
    try {
      ...
      const res = await fetch(
        `https://ochre-dhole-wig.cyclic.app/deleteUser/${id}`,
        {
          method: "delete",
          headers: {
            "Content-Type": "application/json",
  ...
  const UpdateUserRole = async (id, userdata) => {
    try {
      ...
      const { data } = await axios.put(
        `https://ochre-dhole-wig.cyclic.app/updateUserRole/${id}`,
        userdata,
        config
      );
